...
with open('/home/workspace/CarND-Behavioral-Cloning-P3/data_track2/driving_log.csv') as csvfile:
...
# Verify GPU mode
if not os.path.exists('/home/workspace/CarND-Behavioral-Cloning-P3/data_track2/IMG/'):
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for (k, batch_sample) in enumerate(batch_samples):
                ...
                name = '/home/workspace/CarND-Behavioral-Cloning-P3/data_track2/IMG/' + batch_sample[ CENTER_IMAGE ].split('/')[-1]
                name_left  = '/home/workspace/CarND-Behavioral-Cloning-P3/data_track2/IMG/' + batch_sample[  LEFT_IMAGE ].split('/')[-1]
                name_right = '/home/workspace/CarND-Behavioral-Cloning-P3/data_track2/IMG/' + batch_sample[ RIGHT_IMAGE ].split('/')[-1]
